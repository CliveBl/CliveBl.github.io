...
const docDetails = {
    ...
    "capital-gains": {
        ...
        sections: [
            ...
            },
            {
                ...
                content: "הבנקים מנפיקים את האישורים עד סוף חודש מרץ בשנה העוקבת. בדרך כלל, ניתן להוריד אותו מאפליקציית הבנק או מאתר הבנק.",
            },
            {
    ...
    residency: {
        ...
        sections: [
            ...
            {
                title: "מתי מקבלים את האישורים?",
                content: "ניתן לקבל את זה מהרשות המקומית, בדרך כלל מאתר האינטרנט שלהם.",
            },
            {
    ...
    "national-insurance": {
        ...
        sections: [
            ...
            {
                title: "אך מקבלים את האישורים?",
                content: " ניתן לקבל את האישור הזה מאזור האישי שלך בביטוח לאומי  <a href='https://ps.btl.gov.il/#/login'>כאן</a>",
            },
            {
                title: "איזה מסמכים נדרשים?",
                content: `
    ...
    "disability-documents": {
        title: "מסמכי נכות רפואית - פירוט מלא",
        sections: [
            {
                title: "מה הם מסמכי נכות רפואית?",
                content: "מסמכים המעידים על נכות רפואית המזכה בפטור ממס הכנסה לפי סעיף 9(5) לפקודת מס הכנסה.",
            },
            {
                title: "מה כוללים המסמכים?",
                content: `
              - טופס 1516 - בקשה לעדכון נכות רפואית לפטור ממס הכנסה
              - פרוטוקול ועדה רפואית המעידה על הנכות
              - מסמכים רפואיים תומכים
            `,
            },
            {
                title: "מתי נדרשים המסמכים?",
                content: "המסמכים נדרשים כאשר יש נכות רפואית המזכה בפטור ממס הכנסה. יש להגיש את הבקשה למס הכנסה עם כל המסמכים הנדרשים.",
            },
            {
                title: "איך להשיג את המסמכים?",
                content: "ניתן לקבל את טופס 1516 מאתר מס הכנסה <a href='https://www.gov.il/he/service/itc1516'>כאן</a>. פרוטוקול הוועדה הרפואית מתקבל מהוועדה הרפואית שבדקה את הנכות.",
            },
        ],
    },
    "identity-document": {
